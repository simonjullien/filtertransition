...
define(["jquery","libs/jquery-swfobject","console"],function($) {
	...
	var config = {
		...
		getImageData: function(){
			return [
				{'name':'0.jpg', 'path':'CDN_PATH/img/no-sprite/'},
				{'name':'1.jpg', 'path':'CDN_PATH/img/no-sprite/'},
				{'name':'2.jpg', 'path':'CDN_PATH/img/no-sprite/'},
				{'name':'3.jpg', 'path':'CDN_PATH/img/no-sprite/'}
			];
		}
